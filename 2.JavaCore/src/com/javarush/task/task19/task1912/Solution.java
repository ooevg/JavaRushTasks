...
public class Solution {
    ...
    public static void main(String[] args) {
        PrintStream orignConsole = System.out;
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        PrintStream fakeConsole = new PrintStream(byteArrayOutputStream);
        System.setOut(fakeConsole);
        testString.printSomething();
        System.setOut(orignConsole);
        String strForReturn = byteArrayOutputStream.toString().replaceAll("te", "??");
