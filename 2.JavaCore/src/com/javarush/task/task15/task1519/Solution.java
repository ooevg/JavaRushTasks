        ...
        while (!"exit".equals(inputText)) {
            try {
                if (inputText.contains(".")) {
                    print(Double.parseDouble(inputText));
                } else if (Short.parseShort(inputText) > 0 && Short.parseShort(inputText) < 128) {
                    print(Short.parseShort(inputText));
                } else if (Integer.parseInt(inputText) <= 0 || Integer.parseInt(inputText) >= 128) {
                    print(Integer.parseInt(inputText));
                }
