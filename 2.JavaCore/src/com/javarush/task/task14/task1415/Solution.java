...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (Apartment key : apartments) {
            if (key.getClass().getSimpleName().equals("Apt1Room")) {
                ((Apt1Room) key).clean1Room();
            }
            if (key.getClass().getSimpleName().equals("Apt2Room")) {
                ((Apt2Room) key).clean2Rooms();
            }
            if (key.getClass().getSimpleName().equals("Apt3Room")) {
                ((Apt3Room) key).clean3Rooms();
            }
        }
    }
