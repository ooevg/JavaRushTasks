...
public class Solution {
    public static void main(String[] args) throws IOException {
        FileInputStream inputStream = new FileInputStream("/home/ooevg/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task18/task1806/from.txt");
        // Создаем поток-записи-байт-в-файл
        FileOutputStream outputStream = new FileOutputStream("/home/ooevg/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task18/task1806/to.txt");
